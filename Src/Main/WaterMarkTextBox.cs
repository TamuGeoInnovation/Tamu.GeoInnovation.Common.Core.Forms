...
/// http://www.codeproject.com/script/Articles/Article.aspx?aid=27849
namespace USC.GISResearchLab.Common.Core.Forms
{
    public class WaterMarkTextBox : TextBox
    {
        ...
        protected override void OnPaint(PaintEventArgs args)
        {
            ...
            System.Drawing.Font drawFont = new System.Drawing.Font(Font.FontFamily, Font.Size, FontStyle.Italic, Font.Unit);
        ...
        {
            if ((this.Text.Length <= 0) && (!Focused)) EnableWaterMark();
